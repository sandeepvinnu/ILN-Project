...
import './AllSelectedCourseCSS/Python';
...
const Python = () => {
  ...
  return (
    <div className="content">
        <div className="board">
            <h2 className="board-title">Resource</h2>
            <div className="board-card">
            <h3 className="board-card-title">Online</h3>
            <ul>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Download</h3>
            <ul>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Related</h3>
            <ul>
                <li><a href="django.html" title="Django Cheat Sheet">Django</a></li>
            </ul>
            </div>
        </div>
        <div className="board">
            <h2 className="board-title">String</h2>
            <div className="board-card">
            <h3 className="board-card-title">String Methods</h3>
            <ul>
                ...
                <li><a href="http://docs.python.org/library/stdtypes.html#str.isalnum" title="Return true if all characters in the string are alphanumeric and there is at least one character, false otherwise.">isalnum()</a></li>
        ...
        <div className="board">
            <h2 className="board-title">File</h2>
            <div className="board-card">
            <h3 className="board-card-title">Methods</h3>
            <ul>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Attributes</h3>
            <ul>
                ...
                <li><a href="http://docs.python.org/library/stdtypes.html#file.name" title="If the file object was created using open(), the name of the file. ">name</a></li>
        ...
        <div className="board">
            <h2 className="board-title">Set &amp; Mapping</h2>
            <div className="board-card">
            <h3 className="board-card-title">Set Types</h3>
            <ul>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Mapping Types</h3>
            <ul>
                ...
                <li><span title="Set d[key] to value.">d[key] = value</span></li>
        ...
        <div className="board">
            <h2 className="board-title">Date Time</h2>
            <div className="board-card">
            <h3 className="board-card-title">Date Object</h3>
            <ul>
                ...
                <li><a href="http://docs.python.org/library/datetime.html#datetime.date.ctime" title="Return a string representing the date, for example date(2002, 12, 4).ctime() == 'Wed Dec 4 00:00:00 2002'.">ctime()</a></li>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Datetime Object</h3>
            <ul>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Time Object</h3>
            <ul>
                <li><a href="http://docs.python.org/library/datetime.html#datetime.time.replace" title="Return a time with the same value, except for those members given new values by whichever keyword arguments are specified.">replace([hour[, minute[, second[, microsecond[, tzinfo]]]]])</a></li>
        ...
        <div className="board">
            <h2 className="board-title">Array</h2>
            <div className="board-card">
            <h3 className="board-card-title">Array Methods</h3>
            <ul>
                ...
                <li><a href="http://docs.python.org/library/array.html#array.array.tolist" title="Convert the array to an ordinary list with the same items.">tolist()</a></li>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Indexes and Slices</h3>
            <ul>
                <li>a=[0,1,2,3,4,5]</li>
                <li className="right">6</li>
                <li>len(a)</li>
                <li className="right">0</li>
                <li>a[0]</li>
                <li className="right">5</li>
                <li>a[5]</li>
                <li className="right">5</li>
                <li>a[-1]</li>
                <li className="right">4</li>
                <li>a[-2]</li>
                <li className="right">[1,2,3,4,5]</li>
                <li>a[1:]</li>
                <li className="right">[0,1,2,3,4]</li>
                <li>a[:5]</li>
                <li className="right">[0,1,2,3]</li>
                <li>a[:-2]</li>
                <li className="right">[1,2]</li>
                <li>a[1:3]</li>
                <li className="right">[1,2,3,4]</li>
                <li>a[1:-1]</li>
                <li className="right">Shallow copy of a</li>
                <li>b=a[:]</li>
            </ul>
            </div>
        </div>
        <div className="board">
            <h2 className="board-title">Math</h2>
            <div className="board-card">
            <h3 className="board-card-title">Number Theoretic</h3>
            <ul>
                ...
                <li><a href="http://docs.python.org/library/math.html#math.ldexp" title="Return x * (2**i).">ldexp(x,i)</a></li>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Power and Logarithmic</h3>
            <ul>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Trigonometric Functions</h3>
            <ul>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Angular Conversion</h3>
            <ul>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Hyperbolic Functions</h3>
            <ul>
                ...
                <li><a href="http://docs.python.org/library/math.html#math.cosh" title="Return the hyperbolic cosine of x.">cosh(x)</a></li>
            ...
            <div className="board-card">
            <h3 className="board-card-title">Constants</h3>
            <ul>
                <li>math.pi</li>
                <li className="tip">The mathematical constant π = 3.141592..., to available precision.</li>
                <li>math.e</li>
                <li className="tip">The mathematical constant e = 2.718281..., to available precision.</li>
            </ul>
            </div>
        </div>
        <div className="board">
            <h2 className="board-title">Random</h2>
            <div className="board-card">
            <h3 className="board-card-title">Functions</h3>
            <ul>
                ...
                <li><a href="http://docs.python.org/library/random.html#random.vonmisesvariate" title="mu is the mean angle, expressed in radians between 0 and 2*pi, and kappa is the concentration parameter, which must be greater than or equal to zero. ">vonmisesvariate(mu,kappa)</a></li>
        ...
        <div className="board">
            <h2 className="board-title">Sys</h2>
            <div className="board-card">
            <h3 className="board-card-title">Sys Variables</h3>
            <ul>
                <li>argv</li>
                <li className="tip">Command line args</li>
                <li>builtin_module_names</li>
                <li className="tip">Linked C modules</li>
                <li>byteorder</li>
                <li className="tip">Native byte order</li>
                <li>check_-interval</li>
                <li className="tip">Signal check frequency</li>
                <li>exec_prefix</li>
                <li className="tip">Root directory</li>
                <li>executable</li>
                <li className="tip">Name of executable</li>
                <li>exitfunc</li>
                <li className="tip">Exit function name</li>
                <li>modules</li>
                <li className="tip">Loaded modules</li>
                <li>path</li>
                <li className="tip">Search path</li>
                <li>platform</li>
                <li className="tip">Current platform</li>
                <li>stdin, stdout, stderr</li>
                <li className="tip">File objects for I/O</li>
                <li>version_info</li>
                <li className="tip">Python version info</li>
                <li>winver</li>
                <li className="tip">Version number</li>
            </ul>
            </div>
            <div className="board-card">
            <h3 className="board-card-title">sys.argv</h3>
            <ul>
                <li className="right">foo.py</li>
                <li>sys.argv[0]</li>
                <li className="right">bar</li>
                <li>sys.argv[1]</li>
                <li className="right">-c</li>
                <li>sys.argv[2]</li>
                <li className="right">qux</li>
                <li>sys.argv[3]</li>
                <li className="right">--h</li>
                <li>sys.argv[4]</li>
            </ul>
            </div>
        </div>
        <div className="board">
            <h2 className="board-title">OS</h2>
            <div className="board-card">
            <h3 className="board-card-title">os Variables</h3>
            <ul>
                <li>altsep</li>
                <li className="tip">Alternative sep</li>
                <li>curdir</li>
                <li className="tip">Current dir string</li>
                <li>defpath</li>
                <li className="tip">Default search path</li>
                <li>devnull</li>
                <li className="tip">Path of null device</li>
                <li>extsep</li>
                <li className="tip">Extension separator</li>
                <li>linesep</li>
                <li className="tip">Line separator</li>
                <li>name</li>
                <li className="tip">Name of OS</li>
                <li>pardir</li>
                <li className="tip">Parent dir string</li>
                <li>pathsep</li>
                <li className="tip">Patch separator</li>
                <li>sep</li>
                <li className="tip">Path separator</li>
            </ul>
            </div>
        </div>
        <div className="board">
            <h2 className="board-title">Class</h2>
            <div className="board-card">
            <h3 className="board-card-title">Special Methods</h3>
            <ul>
                <li>__new__(cls)</li>
        ...
        <div className="board">
            <h2 className="board-title">String Formatting</h2>
            <div className="board-card">
            <h3 className="board-card-title">Formatting Operations</h3>
            <ul>
                <li>'d'</li>
                <li className="tip">Signed integer decimal.</li>
                <li>'i'</li>
                <li className="tip">Signed integer decimal.</li>
                <li>'o'</li>
                <li className="tip">Signed octal value.</li>
                <li>'u'</li>
                <li className="tip">Obsolete type – it is identical to <tt className="docutils literal"><span className="pre">'d'</span></tt>.</li>
                <li>'x'</li>
                <li className="tip">Signed hexadecimal (lowercase).</li>
                <li>'X'</li>
                <li className="tip">Signed hexadecimal (uppercase).</li>
                <li>'e'</li>
                <li className="tip">Floating point exponential format (lowercase).</li>
                <li>'E'</li>
                <li className="tip">Floating point exponential format (uppercase).</li>
                <li>'f'</li>
                <li className="tip">Floating point decimal format.</li>
                <li>'F'</li>
                <li className="tip">Floating point decimal format.</li>
                <li>'g'</li>
                <li className="tip">Floating point format. Uses lowercase exponential format if exponent is less than -4 or not less than precision, decimal format otherwise.</li>
                <li>'G'</li>
                <li className="tip">Floating point format. Uses uppercase exponential format if exponent is less than -4 or not less than precision, decimal format otherwise.</li>
                <li>'c'</li>
                <li className="tip">Single character (accepts integer or single character string).</li>
                <li>'r'</li>
                <li className="tip">String (converts any Python object using repr().</li>
                <li>'s'</li>
                <li className="tip">String (converts any Python object using str()</li>
                <li>'%'</li>
                <li className="tip">No argument is converted, results in a '%' character in the result.</li>
            </ul>
            </div>
        </div>
        <div className="board">
            <h2 className="board-title">Date Formatting</h2>
            <div className="board-card">
            <h3 className="board-card-title">Date Formatting</h3>
            <ul>
                <li>%a</li>
                <li className="tip">Abbreviated weekday (Sun)</li>
                <li>%A</li>
                <li className="tip">Weekday (Sunday)</li>
                <li>%b</li>
                <li className="tip">Abbreviated month name (Jan)</li>
                <li>%B</li>
                <li className="tip">Month name (January)</li>
                <li>%c</li>
                <li className="tip">Date and time</li>
                <li>%d</li>
                <li className="tip">Day (leading zeros) (01 to 31)</li>
                <li>%H</li>
                <li className="tip">24 hour (leading zeros) (00 to 23)</li>
                <li>%I</li>
                <li className="tip">12 hour (leading zeros) (01 to 12)</li>
                <li>%j</li>
                <li className="tip">Day of year (001 to 366)</li>
                <li>%m</li>
                <li className="tip">Month (01 to 12)</li>
                <li>%M</li>
                <li className="tip">Minute (00 to 59)</li>
                <li>%p</li>
                <li className="tip">AM or PM</li>
                <li>%S</li>
                <li className="tip">Second (00 to 61?)</li>
                <li>%U</li>
                <li className="tip">Week number1 (00 to 53)</li>
                <li>%w</li>
                <li className="tip">Weekday2 (0 to 6)</li>
                <li>%W</li>
                <li className="tip">Week number3 (00 to 53)</li>
                <li>%x</li>
                <li className="tip">Date</li>
                <li>%X</li>
                <li className="tip">Time</li>
                <li>%y</li>
                <li className="tip">Year without century (00 to 99)</li>
                <li>%Y</li>
                <li className="tip">Year (2008)</li>
                <li>%Z</li>
                <li className="tip">Time zone (GMT)</li>
                <li>%%</li>
                <li className="tip">A literal "%" character (%)</li>
            </ul>
            </div>
        </div>
    </div>
